...
def run_predictions(games,date_str):
    ...
    for eid,g in games.items():
        ...
        for pname_raw,pd_ in g['props'].items():
            ...
            elif conviction>=0.23 and fl>=8 and std10<=6 and ha and q25_gate: tier=1; tl='T1_ULTRA'
            elif conviction>=0.18 and fl>=7 and std10<=7 and ha and q25_gate: tier=1; tl='T1_PREMIUM'
            elif conviction>=0.13 and fl>=7 and std10<=7 and ha: tier=1; tl='T1'
            elif conviction>=0.08 and fl>=6 and std10<=8 and ha: tier=2; tl='T2'
            else: tier=3; tl='T3'
            tr=trust.get(pname)
